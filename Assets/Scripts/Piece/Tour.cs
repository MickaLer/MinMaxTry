...
public class Tour : Pieces {
    public Tour(int valeur, Factions factions, string tag, Vector2Int pos) {
        Value = valeur;
        Faction = factions;
        Tag = tag;
        Position = pos;
        ...
        for (var i = 1; i < 8; i++) {
            ...
            if (node.Table[Position.x, Position.y + i] == null) {
                ...
                states.Table[Position.x, Position.y + i] =
                    new Tour(Value, Faction, Tag, new Vector2Int(Position.x, Position.y + i));
        ...
        for (var i = 1; i < 8; i++) {
            ...
            if (node.Table[Position.x + i, Position.y] == null) {
                ...
                states.Table[Position.x + i, Position.y] =
                    new Tour(Value, Faction, Tag, new Vector2Int(Position.x + i, Position.y));
                node.ChildNodes.Add(states);
            }
